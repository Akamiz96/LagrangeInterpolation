 ...
 */
package numerico.bolsadevalores;
...
public class InterfazGráfica extends javax.swing.JFrame {
    ...
    private static void cargarArchivo() {
        ...
        try {
            cargarArchivo(pathArchivo, nombreArchivo);
        } catch (Exception e) {
    ...
    private static void cargarArchivo(String pathArchivo, String nombreArchivo) {
        //TODO Aqui se lee las líneas  del csv entrada
        System.out.println(pathArchivo+nombreArchivo);
    }
